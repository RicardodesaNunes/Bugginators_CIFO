...
# dictionary to implement iteration of different sudoku dificulties
dificulties = {'easy':easy, 'medium':medium, 'hard':hard}

# for each sudoku difficulty
for dificulty in dificulties:
    # run the algorithm 35 times
    for _ in range(35):    
        
        pop = Population(
            size=120,
            optim="max",
            fixed_vals=dificulties[dificulty],
            filename=f"{dificulty}",
